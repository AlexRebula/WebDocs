(function () {
  ...
  var app = angular.module('webDocs', ['ngSanitize']);

  app.controller('WebDocsController', function () {
    this.content = content;
  });

  var content = {
      intro: {
          title: 'Web Docs: AngularJS version',
          subtitle: 'A modern, responsive front-end theme for documentation, built using Twitter Bootstrap and AngularJS',
          author: 'Aleksander Rebula',
          createdOn: 'April 15, 2015'
      },
      chapters: [
      {
          title: "Introduction",
